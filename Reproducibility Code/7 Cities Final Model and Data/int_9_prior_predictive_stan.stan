...
data{
  // shared data - same structure but we won't condition on observed outcomes
  int<lower=1> N;
  ...
  // No observed data needed for prior predictive
...
parameters{
  // sm parameters - sample from priors only
  ...
  //rp parameters - sample from priors only
...
model {
  // ONLY PRIOR SPECIFICATIONS - NO LIKELIHOOD
  // sm priors
...
generated quantities{
  ...
  // Additional quantities of interest for prior checking
